...
class MiscTests: XCTestCase {
    ...
    func testMountSubendpoints() {
        let expectation = self.expectation(description: "Querying GW2Client/misc...")
        GW2Client.instance.misc.mounts.get() { result in
            switch result {
            case .success(_):
                expectation.fulfill()
            case .failure(let error):
    ...
    func testMountTypeIDList() {
        let expectation = self.expectation(description: "Querying GW2Client/misc...")
        GW2Client.instance.misc.mounts.types.get() { result in
            switch result {
            case .success(_):
                expectation.fulfill()
            case .failure(let error):
    ...
    func testMountTypeID() {
        let expectation = self.expectation(description: "Querying GW2Client/misc...")
        GW2Client.instance.misc.mounts.types.get(id: "griffon") { result in
            switch result {
            case .success(_):
                expectation.fulfill()
            case .failure(let error):
    ...
    func testMountTypeIDs() {
        let expectation = self.expectation(description: "Querying GW2Client/misc...")
        GW2Client.instance.misc.mounts.types.get(ids: ["griffon", "springer"]) { result in
            switch result {
            case .success(_):
                expectation.fulfill()
            case .failure(let error):
    ...
    func testMountTypePaged() {
        let expectation = self.expectation(description: "Querying GW2Client/misc...")
        GW2Client.instance.misc.mounts.types.get(page: 0, page_size: 10) { result in
            switch result {
            case .success(_):
                expectation.fulfill()
            case .failure(let error):
    ...
    func testMountSkinIDList() {
        let expectation = self.expectation(description: "Querying GW2Client/misc...")
        GW2Client.instance.misc.mounts.skins.get() { result in
            switch result {
            case .success(_):
                expectation.fulfill()
            case .failure(let error):
    ...
    func testMountSkinID() {
        let expectation = self.expectation(description: "Querying GW2Client/misc...")
        GW2Client.instance.misc.mounts.skins.get(id: 1) { result in
            switch result {
            case .success(_):
                expectation.fulfill()
            case .failure(let error):
    ...
    func testMountSkinIDs() {
        let expectation = self.expectation(description: "Querying GW2Client/misc...")
        GW2Client.instance.misc.mounts.skins.get(ids: [1, 2, 3]) { result in
            switch result {
            case .success(_):
                expectation.fulfill()
            case .failure(let error):
    ...
    func testMountSkinPaged() {
        let expectation = self.expectation(description: "Querying GW2Client/misc...")
        GW2Client.instance.misc.mounts.skins.get(page: 0, page_size: 10) { result in
            switch result {
            case .success(_):
                expectation.fulfill()
            case .failure(let error):
