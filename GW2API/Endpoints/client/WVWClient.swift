...
public class WVWClient : Client {
    ...
    public class WVWAbilitiesClient : Client {
        ...
        public func get(id: Int, completion: @escaping (Result<WVWAbility?, APIError>) -> Void) {
        ...
        ///   - completion: Callback function to handle the data returned from the API (Result<[WVWAbility]?, APIError>)
        public func get(ids: [Int], completion: @escaping (Result<[WVWAbility]?, APIError>) -> Void) {
    ...
    public class WVWMatchesClient : Client {
        ...
        public func get(id: String, completion: @escaping (Result<WVWMatch?, APIError>) -> Void) {
        ...
        ///   - completion: Callback function to handle the data returned from the API (Result<[WVWMatch]?, APIError>)
        public func get(ids: [String], completion: @escaping (Result<[WVWMatch]?, APIError>) -> Void) {
        ...
        public class WVWMatchOverviewClient : Client {
            ...
            public func get(id: String, completion: @escaping (Result<WVWMatchOverview?, APIError>) -> Void) {
            ...
            ///   - completion: Callback function to handle the data returned from the API (Result<WVWMatchOverview?, APIError>)
            public func get(worldID: Int, completion: @escaping (Result<WVWMatchOverview?, APIError>) -> Void) {
            ...
            ///   - completion: Callback function to handle the data returned from the API (Result<[WVWMatchOverview]?, APIError>)
            public func get(ids: [String], completion: @escaping (Result<[WVWMatchOverview]?, APIError>) -> Void) {
        ...
        public class WVWMatchStatsClient : Client {
            ...
            public func get(id: String, completion: @escaping (Result<WVWMatchStats?, APIError>) -> Void) {
            ...
            ///   - worldID: The ID of the world you are searching for
            ///   - completion: Callback function to handle the data returned from the API (Result<WVWMatchStats?, APIError>)
            public func get(worldID: Int, completion: @escaping (Result<WVWMatchStats?, APIError>) -> Void) {
            ...
            ///   - completion: Callback function to handle the data returned from the API (Result<[WVWMatchStats]?, APIError>)
            public func get(ids: [String], completion: @escaping (Result<[WVWMatchStats]?, APIError>) -> Void) {
        ...
        public class WVWMatchScoresClient : Client {
            ...
            public func get(id: String, completion: @escaping (Result<WVWMatchScore?, APIError>) -> Void) {
            ...
            ///   - worldID: The ID of the world you are searching for
            ///   - completion: Callback function to handle the data returned from the API (Result<WVWMatchScore?, APIError>)
            public func get(worldID: Int, completion: @escaping (Result<WVWMatchScore?, APIError>) -> Void) {
            ...
            ///   - completion: Callback function to handle the data returned from the API (Result<[WVWMatchStats]?, APIError>)
            public func get(ids: [String], completion: @escaping (Result<[WVWMatchScore]?, APIError>) -> Void) {
    ...
    public class WVWObjectivesClient : Client {
        ...
        public func get(id: String, completion: @escaping (Result<WVWObjective?, APIError>) -> Void) {
        ...
        ///   - completion: Callback function to handle the data returned from the API (Result<[WVWObjective]?, APIError>)
        public func get(ids: [String], completion: @escaping (Result<[WVWObjective]?, APIError>) -> Void) {
    ...
    public class WVWRanksClient : Client {
        ...
        public func get(id: Int, completion: @escaping (Result<WVWRank?, APIError>) -> Void) {
        ...
        ///   - completion: Callback function to handle the data returned from the API (Result<[WVWRank]?, APIError>)
        public func get(ids: [Int], completion: @escaping (Result<[WVWRank]?, APIError>) -> Void) {
    ...
    public class WVWUpgradesClient : Client {
        ...
        public func get(id: Int, completion: @escaping (Result<WVWUpgrade?, APIError>) -> Void) {
        ...
        ///   - completion: Callback function to handle the data returned from the API (Result<[WVWUpgrade]?, APIError>)
        public func get(ids: [Int], completion: @escaping (Result<[WVWUpgrade]?, APIError>) -> Void) {
